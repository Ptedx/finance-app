...
description: Use sempre ao criar, editar ou refatorar componentes React. Contém diretrizes sobre estruturação de código, gerenciamento de estado e padrões de estilização visual utilizando Typescript.
---
